...
module CoreNutrition
  class Connection < SimpleDelegator
    ...
    #
    # @example
    #   connection = CoreNutrition::Connection.new(url: 'http://example.com') do |conn|
    #     conn.adapter(CoreNutrition::Connection.default_adapter)
    #   end
    #
    #   @connection.headers['Authorization'] = "Bearer 1234"
    #
    # @return [CoreNutrition::Connection] Faraday Connection Delegator
