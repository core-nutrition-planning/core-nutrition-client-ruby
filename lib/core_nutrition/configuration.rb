...
module CoreNutrition
  class Configuration
    ...
    #
    # @example
    #   configuration = CoreNutrition::Configuration.new(access_token: 'abcd')
    #
    ...
    #
    # @return [CoreNutrition::Configuration] Instance of the object
    #
    def initialize(attributes={})
      self.class.keys.each do |key|
        instance_variable_set(:"@#{key}", (attributes[key] || CoreNutrition::Configurations::Default.options[key]))
      end
    end
    ...
    # been initialized.
    #
    # @return [CoreNutrition::Configuration] The configuration instance
    def configure(&block)
      yield(self)
    end
    ...
    # default state
    #
    # @return [CoreNutrition::Configuration] The configuration with Defaults applied
    def reset!
      self.class.keys.each do |key|
        instance_variable_set(:"@#{key}", CoreNutrition::Configurations::Default.options[key])
      end
    end
    alias :setup :reset!
  end
