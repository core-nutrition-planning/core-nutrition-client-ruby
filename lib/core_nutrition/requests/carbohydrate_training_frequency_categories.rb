  ...
  module Requests
    class CarbohydrateTrainingFrequencyCategories
      ...
      def self.list(params={})
        rel   = CoreNutrition::Client.rel_for('rels/carbohydrate-training-frequency-categories')
      ...
      def self.retrieve(id, params={})
        ...
        rel   = CoreNutrition::Client.rel_for('rels/carbohydrate-training-frequency-category')
        route = CoreNutrition::Client.routes.find_by_rel(rel)
