module CoreNutrition
  module Models
    class EventGoalTypes
      ...
      # @param params [Hash]
      #
      # @return [CoreNutrition::Models::EventGoalTypes]
      def self.list(params={})
        request = CoreNutrition::Requests::EventGoalTypes.list(params)
      ...
      # @param params [Hash]
      #
      # @return [CoreNutrition::Models::EventGoalType]
      def self.retrieve(id, params={})
        request = CoreNutrition::Requests::EventGoalTypes.retrieve(id, params)

        request.on(:success) do |resp|
          return CoreNutrition::Models::EventGoalType.new(resp.data_attributes)
        end
      ...
      def internal_collection
        @collection.map { |record| CoreNutrition::Models::EventGoalType.new(record) }
      end
    end
  end
end
