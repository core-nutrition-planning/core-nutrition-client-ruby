module CoreNutrition
  module Models
    class EventUserTypes
      ...
      # @param params [Hash]
      #
      # @return [CoreNutrition::Models::EventUserTypes]
      def self.list(params={})
        request = CoreNutrition::Requests::EventUserTypes.list(params)
      ...
      # @param params [Hash]
      #
      # @return [CoreNutrition::Models::EventUserType]
      def self.retrieve(id, params={})
        request = CoreNutrition::Requests::EventUserTypes.retrieve(id, params)

        request.on(:success) do |resp|
          return CoreNutrition::Models::EventUserType.new(resp.data_attributes)
        end
      ...
      def internal_collection
        @collection.map { |record| CoreNutrition::Models::EventUserType.new(record) }
      end
    end
  end
end
