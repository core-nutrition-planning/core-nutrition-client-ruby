module CoreNutrition
  module Models
    class CarbohydrateTrainingFrequencyCategories
      include Enumerable
      ...
      def self.list(params={})
        request = CoreNutrition::Requests::CarbohydrateTrainingFrequencyCategories.list(params)
      ...
      # @param params [Hash]
      #
      # @return [CoreNutrition::Models::CarbohydrateTrainingFrequencyCategory]
      def self.retrieve(id, params={})
        request = CoreNutrition::Requests::CarbohydrateTrainingFrequencyCategories.retrieve(id, params)

        request.on(:success) do |resp|
          return CoreNutrition::Models::CarbohydrateTrainingFrequencyCategory.new(resp.data_attributes)
        end
      ...
      def internal_collection
        @collection.map { |record| CoreNutrition::Models::CarbohydrateTrainingFrequencyCategory.new(record) }
      end
    end
  end
end
