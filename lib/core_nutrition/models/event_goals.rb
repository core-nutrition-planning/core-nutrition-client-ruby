module CoreNutrition
  module Models
    class EventGoals
      ...
      # @param params [Hash]
      #
      # @return [CoreNutrition::Models::EventGoals]
      def self.list(params={})
        request = CoreNutrition::Requests::EventGoals.list(params)
      ...
      def self.retrieve(id, params={})
        request = CoreNutrition::Requests::EventGoals.retrieve(id, params)

        request.on(:success) do |resp|
          return CoreNutrition::Models::EventGoal.new(resp.data_attributes)
        end
      ...
      def internal_collection
        @collection.map { |record| CoreNutrition::Models::EventGoal.new(record) }
      end
    end
  end
end
